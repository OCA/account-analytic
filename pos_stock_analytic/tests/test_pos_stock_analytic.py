...
class TestPosAnalyticConfig(common.SavepointCase):
    ...
    def test_order_analytic_move(self):
        """Check if analytic account is transimtted to stock move"""
        self.session_01.action_pos_session_closing_control()
        analytic = self.session_01.mapped("picking_ids.move_lines.analytic_account_id")
        self.assertEqual(self.aa_01, analytic)
