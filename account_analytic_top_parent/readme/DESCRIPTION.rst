For each analytic account, defines the top parent analytic account. If there is no parent account, the top parent account is the account itself.
...
Having top parent analytic account enable aggregate reporting for hierarchy of accounts that is not 
...
If we group by top parent analytic account we get:
