...
class TestAccountInvoiceLine(TransactionCase):
    ...
    def test_top_parent_if_no_parent_returns_itself(self):
        self.assertEqual(self.analytic_account_A.top_parent_id, 
                         self.analytic_account_A.top_parent_id)

    def test_top_parent_if_parent(self):
        self.assertEqual(self.analytic_account_AB.top_parent_id, self.analytic_account_A)

    def test_top_parent_if_grand_parent(self):
        self.assertEqual(self.analytic_account_ABC.top_parent_id, self.analytic_account_A)
