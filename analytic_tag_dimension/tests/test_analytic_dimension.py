...
class TestAnalyticDimensionBase(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.analytic_tag_1a = cls.tag_obj.create({
            "name": "Test tag 1A",
            "analytic_dimension_id": cls.dimension_1.id,
        })
        ...
        cls.analytic_tag_2a = cls.tag_obj.create({
            "name": "Test tag 2A",
            "analytic_dimension_id": cls.dimension_2.id,
        })
...
class TestAnalyticDimensionCase(TestAnalyticDimensionBase):
    ...
    def test_analytic_entry_dimension(self):
        ...
        line = self.analytic_line_obj.create({
            ...
            'name': 'test',
            'tag_ids': [
                (4, self.analytic_tag_1a.id), (4, self.analytic_tag_2a.id),
            ],
        })
    ...
    def test_zz_dimension_rename(self):
        ...
        self.assertIn(
            "x_dimension_test_renamed", self.analytic_line_obj._fields
        )
        self.assertIn(
            "x_dimension_test_renamed", self.env["account.move.line"]._fields
        )
        self.assertIn(
            "x_dimension_test_renamed", self.env["account.invoice.line"]._fields
        )
